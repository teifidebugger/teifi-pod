...
export const ACTION_TARGET_CONFIG: Partial<Record<UATColumn, ActionTargetConfig>> = {
        ...
        primaryClass: "bg-emerald-600 hover:bg-emerald-700 text-white border-0",
        isPrimary: true,
    ...
    submitted: {
        ...
        primaryClass: "border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-950/40",
        isPrimary: false,
